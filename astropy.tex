...
%%     c. fast enough for â"big data"â (not there yet)
...
however, it requires an observer location, the time of observation,
...
unambiguous by itself, so in this case the additional \texttt{unit} argument is required to
...
heterogeneous data types, and any number of rows. Numpy structured arrays areâˆ
