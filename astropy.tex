...
We would like to thank the \gls{numpy}, \gls{scipy}, \gls{ipython} and \gls{matplotlib} communities for providing their packages which are invaluable to the development of \gls{astropy}. In particular, we would like to thank John Hunter, who created \gls{matplotlib} and thus was (unfortunately passed away 2012) one of the enablers of python in scientific context. Furthermore, we would like to thank Enthought and continuum.io which provide funding for the python scientific communities. 

Without Github \gls{astropy} would have been a much harder endeavour. We thank the Github team for providing us with a free development platform. Other notable projects that provided free services to \gls{astropy} are readthedocs, jenkins, and, Travis CI.

Finally, we would like to thank the users that have tried \gls{astropy} and provided feedback and submitted bugs. 
