...
Henry Ferguson\inst{\ref{inst:stsci}}  % confirmed
  \and
Frédéric Grollier\inst{\ref{inst:freelance}}  % confirmed
  \and
...
compressed using the \gls{gzip} and \gls{bzip2} algorithms are
supported transparently.  It also supports reading VOTable files
