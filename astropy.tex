...
Tim Jenness\inst{\ref{inst:jac}}  % confirmed
  \and
Kathleen Labrie\inst{\ref{inst:gemini_s}}  % confirmed
  \and
...
their position on the sky sphere.  This library is specific to WCS as
it relates to FITS as described in the FITS WCS papers
