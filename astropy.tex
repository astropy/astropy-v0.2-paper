...
\texttt{Quantity} objects support arithmetic. When adding or subtracting, if the units are equivalent but not equal (e.g. centimeter and meter), the resulting object has units of the object on the left:
\begin{verbatim}
>>> 110. * u.cm + 1.5 * u.m 
<Quantity 260.0 cm>
>>> 1.5 * u.m  + 110. * u.cm
