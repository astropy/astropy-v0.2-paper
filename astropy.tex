...
A final significant feature of \texttt{astropy.coordinates} is support for line of
...
example of such a user-defined system is provided at
\url{http://docs.astropy.org/en/v0.2/coordinates/sgr-example.html#complete-code-for-example},
illustrating the definition of a coordinate system useful for a specific scientific
task (modeling the Sgr dwarf spheroidal galaxy's tidal tails).
