...
Parsing, manipulating, and converting astronomical coordinates is an
essential workflow element for astronomers. The
\texttt{astropy.coordinates} sub-package contains classes and
functions that bring this functionality to Python. This sub-package
was designed to present a pythonic interface for handling coordinate
system representation and formatting, conversions between coordinate
systems, and to provide a set of base coordinate classes upon which
users may customize and implement new systems. The ultimate goal is to
seamlessly support arbitrarily large data sets while maintaining an
easy-to-use yet extensible API.

The \texttt{astropy.coordinates} sub-package is built around a set of
classes that represent coordinate systems.  The abstract class
