...
Internally, the individual coordinates are store as \texttt{Angle}
...
controlling string representations of the value. The user may specify
separating characters (for sexagesimal representation), the output
unit, and precision:

\begin{verbatim}
>>> a.format(sep=":", precision=8)
u'118:26:21.24240000'
>>> a.format(unit=u.hour, sep="hms")
u'7h53m45.41616s'
\end{verbatim}
