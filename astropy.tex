...
Tables and n-dimensional data arrays are the most common forms of data encountered in astronomy. The \textit{Python}-community 

current implementations recarray, pandas, pytables, ndarray, array

missing features mainly metadata, units, uncertainties, masks, flags, io for common astronomical data formats
