...
homogeneity across packages. This has made it difficult for users to
...
integration, clustering). To date, over 180 people are
signed up to the development mailing list for the Astropy
project\footnote{
\url{https://groups.google.com/forum/?fromgroups#!forum/astropy-dev}}.

The initial aim of the Astropy project was to create a core \astropy package,
and thus most development efforts have gone towards the first public release presented here.
However, the scope of the Astropy project is
...
set of functionality in the core package, since the aim is
...
(\url{http://www.cython.org/})} and are reasonably fast and memory efficient.

% TODO: quantify the speed
